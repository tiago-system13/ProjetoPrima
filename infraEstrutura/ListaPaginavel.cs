...
{
    /// <summary>
    /// Classe que implementa um lista paginada.
    /// Facilita o tratamento de consultas paginadas em uma fonte dae dados
    /// </summary>
    /// <typeparam name="T">O tipo do objeto da Lista</typeparam>
    public class ListaPaginavel<T> : List<T>
    {
        public int IndiceDePagina { get; private set; }

        public int NumeroDeRegistrosPorPagina { get; private set; }
